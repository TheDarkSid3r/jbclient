(window.webpackJsonp = window.webpackJsonp || []).push([[25], {
                ...
                , I = c.a.View.extend({
                    ...
                    bindings: {
                        ...
                        ".parentErrorText": {
                            ...
                            updateMethod: "html",
                            onGet: function (e) {
                                return e ? "object" === w(e) ? e.html ? e.html : t("<div />").text(e.text).html() : e : null
                            }
                        }
                    },
                    initialize: function (t) {
                        this.shouldSubmit = !1,
                            ...
                            this.inputsComponent = new l.a,
                            this.buttonsCollection = new a.a.Collection([{
                                text: "submit"
                            }]),
                    ...
                    update: function () {
                        ...
                        if (this.model.get("actions").forEach((function (e) {
                            e.action || (e.action = e.key),
                                t.push(e)
                        }
                        )),
                            this.buttonsCollection.set(t),
                            this.inputsComponent.collection.length !== this.model.get("fieldCount")) {
                            for (var e = [], n = this.model.get("fieldCount"); n > 0; n--)
                                e.push(y({}, this.model.attributes, {
                                    counter: !0,
                                    hideError: !0,
                                    isLastChild: 1 === n
                                }));
                    ...
                    onRender: function () {
                        this.showChildView("prompt", this.promptComponent),
                            this.showChildView("inputs", this.inputsComponent),
                    ...
                    onChildviewInputSubmit: function () {
                        ...
                        return n ? (e.textKey = n,
                            e.val = t.join("\n"),
                            this.triggerMethod("client:message", e)) : g.app.client.send("SendMessageToRoomOwner", e),
                            this.$el.find(".enterTextListFieldset").prop("disabled", !1),
                            !1
                    },
                    onChildviewChildviewButtonChoose: function (t) {
                        return this.onChildviewInputSubmit(),
                            !1
                    }
                })
        }
                ...
                n(748).a.extend({
                    ...
                    onKeypress: function (t) {
                        return this.model.set("error", ""),
                            13 !== t.keyCode || (this.model.get("isLastChild") ? this.triggerMethod("input:submit", this) : this.triggerMethod("input:focusNext", this),
                                !1)
                    }
                }))
    },
    ...
    2862: function (t, e, n) {
        ...
        var i = n(41)
            ...
            , u = s.a.extend({
                ...
                onChildviewInputSubmit: function () {
                    ...
                    if (this.model.setUpdate({
                        ...
                        !this.model.get("autoSubmit") && 0 === t.length && !this.model.get("allowEmpty"))
                        return this.model.setUpdate({
                            error: this.model.get("strings").ERROR_NOTHING_ENTERED
                        }),
                            !1;
                    ...
                    return n && (e.textKey = n,
                        ...
                        this.model.get("isAudience") ? this.model.get("repeating") ? this.inputComponent.clearInput() : (this.audienceEntry = t,
                ...
                update: function () {
                    ...
                    this.model.get("entry") || this.model.get("actions").forEach((function (t) {
                        ...
                        }, t) : (t.action || (t.action = t.key),
                            e.push(t))
                    }
                    ));
                    this.buttonsCollection.set(e),
                        this.model.get("autoSubmit") && this.onChildviewInputSubmit()
                },
                onChildviewChildviewButtonChoose: function (t) {
                    ...
                    return this.triggerMethod("client:message", i),
                        !1
                }
            })
            , c = n(1024)
            ...
            , x = v.a.extend({
                initialize: function (t) {
                    this.model.set("length", 0),
                        v.a.prototype.initialize.apply(this, t)
                },
            ...
            , j = n.n(T)
            , k = w.a.extend({
                template: p.a.template(j.a),
                regions: p.a.extend({}, w.a.prototype.regions, {
                    toggle: "#toggleRegion"
                }),
                initialize: function () {
                    this.inputComponent = this.inputComponent || new x({
                        ...
                        this.toggleComponent = this.toggleComponent || new E,
                        w.a.prototype.initialize.apply(this)
                },
                onRender: function () {
                    w.a.prototype.onRender.apply(this),
                        this.showChildView("toggle", this.toggleComponent)
                },
                update: function () {
                    w.a.prototype.update.apply(this),
                        this.toggleComponent.model.setUpdate(this.model.get("toggle"))
                },
                onChildviewInputSubmit: function () {
                    var t, e;
                    if (-1 !== this.model.get("validActions").indexOf("add") ? (t = "add",
                        ...
                        this.inputComponent.clearInput()) : -1 !== this.model.get("validActions").indexOf("title") && (t = "title",
                            e = this.titleInputComponent.getSanitizedValue(),
                        ...
                        "add" == t && this.toggleComponent.getValue() && (n.type = "thriplash"),
        ...
        var A = f.a.extend({
            ...
            bindings: function (t) {
                ...
                return t
            }({}, f.a.prototype.bindings, {
                "#controller-container": {
                    attributes: [{
                        name: "class",
                        observe: "player",
                        onGet: function (t) {
                            if (t && t.playerInfo && t.playerInfo.avatar)
                                return "Logo" == t.state ? t.classes ? "Logo ".concat(t.classes.join(" ")) : "Logo" : t.playerInfo.avatar
                        }
                    }, {
                        name: "class",
                        ...
                        onGet: function (t) {
                            var e = V(t, 3)
                                ...
                                , o = e[2];
                            if (n && i) {
                                if (L.app.client.isRole("audience")) {
                                    if (!n.audience || !n.audience.state || !o)
                                        return;
                                    var a = o.audience.classes;
                                    return "Logo" == n.audience.state && "MakeSingleChoice" !== o.audience.state ? "".concat(a, " Audience Logo") : "Audience ".concat(a)
                                }
                                return "UGC" == i.state ? "UGCView" : void 0
                            }
                        }
                    }]
                }
            ...
            parseBlob: function (t) {
                return t.classes = t.classes || [],
                    t.playerInfo = t.playerInfo || {},
                    t.playerInfo.classes = t.playerInfo.classes || [],
                    t.playerInfo.avatar && (t.classes = p.a.union(t.classes, [t.playerInfo.avatar]),
                        t.playerInfo.classes = p.a.union(t.playerInfo.classes, [t.playerInfo.avatar])),
                    t.isAudience && (t.playerInfo = {
                        username: "AUDIENCE",
                        classes: ["Audience"]
                    }),
                    "UGC" == t.state && (t.playerInfo.classes = p.a.union(t.playerInfo.classes, ["UGCView"])),
                    t
            }
        })
    },
        ...
        var r = [169, 174, 8252, 8265, 8482, 8505, 8596, 8597, 8598, 8599, 8600, 8601, 8617, 8618, 9e3, 8986, 8987, 9167, 9193, 9194, 9195, 9196, 9197, 9198, 9199, 9200, 9201, 9202, 9203, 9209, 9210, 9410, 9642, 9643, 9654, 9664, 9723, 9724, 9725, 9726, 9728, 9729, 9730, 9731, 9732, 9742, 9745, 9748, 9749, 9752, 9757, 9760, 9762, 9763, 9766, 9770, 9774, 9775, 9784, 9785, 9786, 9792, 9794, 9800, 9801, 9802, 9803, 9804, 9805, 9806, 9807, 9808, 9809, 9810, 9811, 9824, 9827, 9829, 9830, 9832, 9851, 9854, 9855, 9874, 9875, 9876, 9877, 9878, 9879, 9881, 9883, 9884, 9888, 9823, 9889, 9895, 9898, 9899, 9904, 9905, 9917, 9918, 9924, 9925, 9928, 9934, 9935, 9937, 9939, 9940, 9961, 9962, 9968, 9969, 9970, 9971, 9972, 9973, 9974, 9975, 9976, 9977, 9978, 9981, 9986, 9989, 9992, 9993, 9994, 9995, 9996, 9997, 9999, 10002, 10004, 10006, 10013, 10017, 10024, 10035, 10036, 10052, 10055, 10060, 10062, 10067, 10068, 10069, 10071, 10083, 10084, 10085, 10133, 10134, 10135, 10145, 10160, 10175, 10548, 10549, 11013, 11014, 11015, 11035, 11036, 11088, 11093, 12336, 12349, 12951, 12953, 58634]
            ...
            , c = function (t, e) {
                for (var n = "", i = !0; i && e < t.length;) {
                    ...
                    if (h(o)) {
                        var a = d(o, t[e + 1]);
                        u.includes(a) ? (n = n + o + t[e + 1],
                            e += 2) : i = !1
                    } else
                        p(o, 8205) ? (n = n + o + t[e + 1] + t[e + 2],
                            e += 3) : i = !1
                }
                return [n, e]
            }
            ...
            , g = function (t, e) {
                ...
                for (var n, i = t.split(""), o = 0, a = "", g = 0; g < i.length && (!e || o < e); g++) {
                    var m = i[g];
                    if (/[\u00A1\u0020-\u0022\u0024-\u0029\u002B-\u002F\u003A-\u007E\u00BF-\u00FF’]/gi.test(m))
                        a += m,
                            o++;
                        ...
                        if (n = void 0,
                            n = parseInt(m.charCodeAt(0).toString(16), 16),
                            r.includes(n)) {
                            if (a += m,
                                p(m, 9977)) {
                                g++;
                        ...
                        if (h(m)) {
                            ...
                            if (127987 == y) {
                                var I = i[g + 1];
                                p(I, 65039) && (g++,
                                    p(i[g + 1], 8205) && (a = a + I + i[g + 1] + i[g + 2] + i[g + 3],
                                        g += 3)),
                                    o++;
                                continue
                            }
                        ...
                        if (/[\u0023\u002A\u0030-\u0039]/.test(m)) {
                            var S = i[g + 1];
                            S && p(S, 65039) ? (a = a + m + i[g + 1] + i[g + 2],
                                g += 2) : a += m,
                                o++;
                            continue
                        }
                        (p(m, 65039) || p(m, 8205) || p(m, 8419)) && (a += m)
                    }
                }
                return {
                    result: a,
            ...
            , v = i.a.extend({
                ...
                initialize: function (t) {
                    this.model.set("length", 0),
                        i.a.prototype.initialize.apply(this, t)
                },
                onInputChange: function () {
                    var t = this.$("textarea").first();
                    if (t.length) {
                        var e = g(t.val(), this.model.get("maxLength"));
                        this.model.set("length", e.charCount),
                            t.val(e.result)
                    }
                },
                getSanitizedValue: function () {
                ...
                sanitizeInput: function (t) {
                    return g(t, this.model.get("maxLength")).result
                }
            })
    }
}]);
//# sourceMappingURL=25.5231b95a1068cfbde4c5.js.map
